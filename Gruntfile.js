...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      spellCheck: {
        command:
          "mdspell -r -n -a --en-us faq/**/*.md how-to/**/*.md working-in-government/**/*.md"
      },
      linkChecker: {
    ...
    sass: {
      dist: {
        ...
        files: [
          {
            src:
              "node_modules/usajobs-design-system/css/usajobs-design-system-base--help-center.css",
    ...
    concurrent: {
      serve: ["css", "watch", "shell:jekyllServe"],
      options: {
